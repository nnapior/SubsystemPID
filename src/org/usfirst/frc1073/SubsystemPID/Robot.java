...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        frontLeftPIDThread = new PIDThread(0.06, 0.06, 0.06, 5, .003, 0);
        frontRightPIDThread = new PIDThread(0.06, 0.06, 0.06, 5, .003, 1);
        backLeftPIDThread = new PIDThread(0.06, 0.06, 0.06, 5, .003, 2);
        backRightPIDThread = new PIDThread(0.06, 0.06, 0.06, 5, .003, 3);
    ...
    public void teleopInit() {
        ...
        frontLeftPIDThread.setPIDObjects(encoderSystem, driveTrain, Robot.driveTrain.getDriveCommand());
        frontRightPIDThread.setPIDObjects(encoderSystem, driveTrain, Robot.driveTrain.getDriveCommand());
        backLeftPIDThread.setPIDObjects(encoderSystem, driveTrain, Robot.driveTrain.getDriveCommand());
        backRightPIDThread.setPIDObjects(encoderSystem, driveTrain, Robot.driveTrain.getDriveCommand());
